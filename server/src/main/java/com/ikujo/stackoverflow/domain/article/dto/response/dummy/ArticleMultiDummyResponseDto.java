...
public record ArticleMultiDummyResponseDto(
    ...
    public static ArticleMultiDummyResponseDto of(String nickname, Long memberId, Long id, String title, String content,
                                             String tag, Integer recommendCount, Long hits, Boolean selection, Integer commentCount) {
        ...
        return new ArticleMultiDummyResponseDto(member, id, title, content, tags, recommendCount, hits, baseTimeDto, selection, commentCount);
    }
